...
class Net(network.resnet38d.Net):
    def __init__(self):
        ...
        torch.nn.init.xavier_uniform_(self.fc_proj_256.weight, gain=4)
    ...
    def forward(self, x):
        ...
        """
        TODO: f_all_res relu 씌울 것인가 말것인가?
        """

        # f_all_res = F.relu(self.fc_proj_256(f_all_res), inplace=True)
        ...
        """
        # return cam, cam_rv, f_proj, cam_rv_down, f_all_res, d['conv6']
