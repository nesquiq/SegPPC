...
class Net(nn.Module):
    ...
    def forward_as_dict(self, x):
        ...
        """
        TODO: replace b2, b3 to return conv1, conv2 output
              add bn for conv1a and make it return conv0
        --> Done
        """
    ...
    def train(self, mode=True):
        ...
        for layer in self.modules():
            ...
            if isinstance(layer, torch.nn.BatchNorm2d): # --> nn.SyncBatchNorm
                layer.eval()
